...
use shared::{Bones, Data, EntityInfo, PlayerData, RuntimeData, Weapon, WeaponInfo};
...
impl CS2 {
    ...
    pub fn data(&mut self, data: &mut Data) {
        ...
        for player in &self.players {
            ...
            let (collision_mins, collision_maxs) = player.collision_bounds(self);
        ...
        let (collision_mins, collision_maxs) = local_player.collision_bounds(self);
