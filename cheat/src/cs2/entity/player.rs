...
use crate::cs2::{
    ...
    entity::{
        ...
        weapon::{weapon_clip_ammo, weapon_from_entity, weapon_from_handle, weapon_reserve_ammo},
    },
};
...
impl Player {
    ...
    pub fn weapon_snapshot(&self, cs2: &CS2) -> (Weapon, (i32, i32)) {
        ...
        (
            weapon_from_entity(weapon, cs2),
            (
                weapon_clip_ammo(weapon, cs2),
                weapon_reserve_ammo(weapon, cs2),
            ),
        )
    }
